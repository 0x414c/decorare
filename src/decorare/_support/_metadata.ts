...
export const _defineMetadata = <TMetadata extends object>(
  target: object, metadataKey: symbol, metadata: TMetadata,
): void => Reflect.defineMetadata(metadataKey, metadata, target);


export const _definePropertyMetadata = <TMetadata extends object>(
  target: object, metadataKey: symbol, metadata: TMetadata, propertyKey: PropertyKeyT,
): void => Reflect.defineMetadata(metadataKey, metadata, target, propertyKey);
...
export const _getOwnMetadata = <TMetadata extends object>(target: object, metadataKey: symbol): OptionalT<TMetadata> =>
  Reflect.getOwnMetadata(metadataKey, target);


export const _getOwnPropertyMetadata = <TMetadata extends object>(
  target: object, metadataKey: symbol, propertyKey: PropertyKeyT,
): OptionalT<TMetadata> => Reflect.getOwnMetadata(metadataKey, target, propertyKey);
